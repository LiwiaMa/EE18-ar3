...
<body>
    <div class="container">
        <h1>Vilket är Europas folkrikaste land? </h1>
        <form action="#" method="POST">
            <label for="namn">Ange landet </label>
       ...
       if (isset($_POST["land"])) {
        ...
        if ($land == "ryssland") {
            echo "<p>Rätt $land är det folkrikaste landet i Europa</p>";
        } else {
            echo "<p> $land är inte det folkrikaste landet i Europa</p>";
        }
