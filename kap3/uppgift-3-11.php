...
<body>
    <div class="container">
        <h1>Kommer du få köpa kaffet extra billigt? </h1>
        <form action="#" method="POST">
            <label for="namn">Ange din ålder </label>
            <input id="namn" class="form-control" type="text" name="alder" required>
       ...
       if (isset($_POST["alder"])) {
        ...
        if ($alder > 11 && $alder < 19 || $alder > 64) {
            echo "<p>Grattis! Du får kaffet extra billigt</p>";
        } 
        else {
            echo "<p>Tyvärr, du får inte kaffet extra billigt</p>";
        }
